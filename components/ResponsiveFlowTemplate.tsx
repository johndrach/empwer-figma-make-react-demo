import svgPaths from "../imports/svg-z9smu39mje";

function HeaderOverlay() {
  return (
    <div
      className="absolute bg-gradient-to-t from-50% from-[#f5f6f6] h-[440px] left-1/2 to-[#ffffff] top-0 translate-x-[-50%] w-full max-w-[1440px]"
...
function Button() {
  return (
    ...
    >
      <Language />
      <div className="font-['Open_Sans:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#454a53] text-[16px] text-center text-nowrap tracking-[0.24px] max-[375px]:hidden">
...
function TrailingActions() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-3 lg:gap-5 items-center justify-start p-0 right-4 lg:right-10 top-5"
...
function LogoNewAlt1() {
  return (
    <div
      className="absolute h-4 top-8 w-32 lg:w-40 left-1/2 transform -translate-x-1/2"
...
function NavigationBar() {
  return (
    <div
      className="absolute h-20 left-0 overflow-clip top-0 w-full"
...
function Header() {
  return (
    <div
      className="bg-[#ffffff] relative shrink-0 w-full max-w-none lg:max-w-[784px]"
      data-name="header"
    >
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row items-center justify-between p-4 lg:p-[16px] relative w-full">
          <div className="flex items-center justify-center relative shrink-0">
            <div className="flex-none rotate-[180deg] scale-y-[-100%]">
              <Arrow />
            </div>
          ...
          <Frame71174622 />
          <div className="absolute font-['Open_Sans:Regular',_sans-serif] leading-[0] left-1/2 not-italic text-[#5f6065] text-[14px] lg:text-[16px] text-center text-nowrap top-1/2 tracking-[2.8px] lg:tracking-[3.2px] translate-x-[-50%] translate-y-[-50%] uppercase">
            <p className="adjustLetterSpacing block leading-[20px] whitespace-pre">
              Account funding
            </p>
          </div>
...
function Frame1171273461() {
  return (
    <div className="box-border content-stretch flex flex-col gap-4 items-center justify-start p-0 relative shrink-0 w-full">
      <div className="css-agmlph font-['Open_Sans:Bold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#454a53] text-[20px] lg:text-[24px] text-center tracking-[-0.24px] w-full">
        <p className="block leading-[28px] lg:leading-[32px]">Let us help you</p>
      </div>
    </div>
  );
}
...
function DynamicSpacer() {
  return (
    ...
    >
      <div className="basis-0 bg-[rgba(255,255,255,0)] grow h-6 min-h-px min-w-px relative shrink-0" />
    </div>
  );
}
...
function Frame3976() {
  return (
    <div className="w-full max-[588px]:order-1 min-[589px]:basis-0 min-[589px]:grow min-[589px]:min-h-px min-[589px]:min-w-px bg-[#ffffff] relative rounded-xl self-stretch shrink-0 min-[589px]:w-auto">
      <div className="absolute border border-[#d6d6d6] border-solid inset-0 pointer-events-none rounded-xl" />
      <div className="flex flex-col items-center relative size-full">
        <div className="box-border content-stretch flex flex-col gap-4 items-center justify-start px-6 lg:px-8 py-6 relative size-full">
          <Form />
          <div className="css-jp2iid font-['Open_Sans:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#454a53] text-[16px] text-center w-full max-w-[264px]">
...
function Frame1171273462() {
  return (
    <div className="box-border content-stretch flex flex-col gap-4 items-center justify-start p-0 relative shrink-0 w-full">
      <div className="css-agmlph font-['Open_Sans:Bold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#454a53] text-[20px] lg:text-[24px] text-center tracking-[-0.24px] w-full">
        <p className="block leading-[28px] lg:leading-[32px]">Do it myself</p>
      </div>
    </div>
  );
}
...
function Frame71174212() {
  return (
    <div className="w-full max-[588px]:order-2 min-[589px]:basis-0 min-[589px]:grow min-[589px]:min-h-px min-[589px]:min-w-px bg-[#ffffff] relative rounded-xl shrink-0 min-[589px]:w-auto">
      <div className="absolute border border-[#d6d6d6] border-solid inset-0 pointer-events-none rounded-xl" />
      <div className="flex flex-col items-center relative size-full">
        <div className="box-border content-stretch flex flex-col gap-4 items-center justify-start px-6 lg:px-8 py-6 relative w-full">
          <PeopleMale02 />
          <Form1 />
          <div className="css-jp2iid font-['Open_Sans:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#454a53] text-[16px] text-center w-full max-w-[264px]">
            <p className="block leading-[22px]">
...
function Selection() {
  return (
    <div
      className="box-border content-stretch flex flex-col min-[589px]:flex-row gap-4 items-start justify-start p-0 relative shrink-0 w-full max-w-[672px]"
      data-name="selection"
    >
      <Frame3976 />
      <Frame71174212 />
...
function Frame71174603() {
  return (
    <div className="box-border content-stretch flex flex-col gap-6 items-center justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Open_Sans:Bold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#04060b] text-[24px] lg:text-[28px] text-center tracking-[-1px] w-full max-w-[600px] px-4">
        <p className="block leading-[28px] lg:leading-[32px]">
...
function Widget() {
  return (
    <div
      className="bg-[#ffffff] min-h-[420px] relative rounded-3xl shadow-[0px_10px_60px_-15px_rgba(12,64,81,0.07)] shrink-0 w-full max-w-[784px] mx-auto"
      data-name="Widget"
    >
      <div className="flex flex-col items-center min-h-inherit overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-6 items-center justify-start min-h-inherit pb-8 lg:pb-16 pt-0 px-0 relative w-full">
          <Header />
          <div className="px-6 max-[588px]:px-6 lg:px-0 w-full flex justify-center">
            <Frame71174603 />
          </div>
        </div>
      </div>
...
function Frame71174486() {
  return (
    <div className="w-full max-w-[1200px] mx-auto px-4 lg:px-8 pt-[104px]">
      <Widget />
      <div className="font-['Open_Sans:Regular',_sans-serif] leading-[0] not-italic mt-4 text-[#47494e] text-[14px] text-center w-full">
...
export default function ResponsiveFlowTemplate() {
  return (
    <div className="bg-[#f6f6f6] relative min-h-screen w-full" data-name="Flow template">
      <HeaderOverlay />
      <NavigationBar />
      <Frame71174486 />
    </div>
